  ...
  capabilities: [
    {
      ...
      summary: 'Fast, responsive interfaces with component structure, motion, and user-first flow.',
      skills: ['Vue.js', 'React', 'TailwindCSS', 'SVG', 'GSAP'],
    },
    {
      title: 'Backend & Data',
      signal: 'Application core',
      summary: 'Practical APIs, schemas, persistence, and integrations for products that need real state.',
      skills: ['Node.js', 'Express', 'SQLite', 'Supabase', 'SQL'],
    },
    {
      title: 'Auth & Security',
      signal: 'Trust layer',
      summary: 'Login flows, sessions, OAuth, rate limits, and logging built into the system early.',
      skills: ['OAuth2', 'Supabase', 'Node.js', 'Nginx'],
    },
    {
      title: 'Deployment & Ops',
      signal: 'Ship and maintain',
      summary: 'Linux hosting, reverse proxies, Cloudflare, and CI habits that make software stay online.',
